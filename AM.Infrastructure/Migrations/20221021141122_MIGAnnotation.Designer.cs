...
namespace AM.Infrastructure.Migrations
{
    ...
    [Migration("20221021141122_MIGAnnotation")]
            ...
            modelBuilder.Entity("FlightPassenger", b =>
                {
                    ...
                    b.Property<string>("PassengersListPasseportNumber")
                        .HasColumnType("nvarchar(7)");

                    b.HasKey("FlightsFlightId", "PassengersListPasseportNumber");

                    b.HasIndex("PassengersListPasseportNumber");
            ...
            modelBuilder.Entity("FlightPassenger", b =>
                {
                    ...
                    b.HasOne("AM.ApplicationCore.Domain.Passenger", null)
                        .WithMany()
                        .HasForeignKey("PassengersListPasseportNumber")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
